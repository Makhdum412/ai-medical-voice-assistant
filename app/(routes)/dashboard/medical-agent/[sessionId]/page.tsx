  ...
  return (
    <div className='p-5 border rounded-3xl bg-secondary'>
      ...
      {sessionDetails && <div className='flex items-center flex-col mt-10'>
        <Image src={sessionDetails?.selectedDoctor.image} alt={sessionDetails?.selectedDoctor.specialist} width={120} height={120} className='w-[100px] h-[100px] object-cover rounded-full' />
        <h2 className='mt-2 text-lg font-bold'>{sessionDetails?.selectedDoctor?.specialist}</h2>
        ...
        <div className='mt-32'>
         ...
         <Button> <PhoneCall/> Start Call</Button>
